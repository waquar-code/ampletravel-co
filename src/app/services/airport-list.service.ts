...
const airport_list = [
  ...
  ['Kumasi', 'Kumasi International Airport', 'KMS'],
  ...
  ['Bangui', ' bal international airport ', 'BGF'],
  ...
  ['Roseau', 'Douglas–Charles Airport', 'DOM'],
  ...
  ['Saint Georges', 'Maurice Bishop International Airport', 'GND'],
  ...
  ['Basseterre', 'Robert L. Bradshaw International Airport', 'SKB', 'TKPK'],
  ...
  ['Panama City', 'Panama Pacifico International Airport', 'BLB'],
  ...
  ['St. John', 'Saint John Airport', 'YSJ', 'New Brunswick'],
  [
    "St. John's",
  ...
  ['León', 'Bajío International Airport', 'BJX'],
  ...
  ['Morelia', 'General Francisco Mujica International Airport', 'MLM'],
  ['Oaxaca City', 'Oaxaca International Airport', 'OAX'],
  ['Puebla', 'Puebla International Airport', 'PBC'],
  ...
  ['Querétaro City', 'Querétaro Intercontinental Airport', 'QRO'],
  ['Reynosa', 'General Lucio Blanco International Airport', 'REX'],
  ['Saltillo', 'Saltillo Airport', 'SLW'],
  ...
  ['Toluca', 'Toluca International Airport', 'TLC'],
  ['Torreón', 'Torreón International Airport', 'TRC'],
  ['Tulum', 'Tulum International Airport', 'TQO'],
  ['Tuxtla Gutiérrez', 'Tuxtla Gutiérrez International Airport', 'TGZ'],
  ['Uruapan', 'Uruapan International Airport', 'UPN'],
  ['Veracruz', 'Veracruz International Airport', 'VER'],
  ['Villahermosa', 'Villahermosa International Airport', 'VSA'],
  ['Zacatecas City', 'Zacatecas International Airport', 'ZCL'],
  ...
  ['Anchorage', 'Anchorage International Airport', 'ANC'],
  ...
  ['Jackson (MS)', 'Jackson–Medgar Wiley Evers International Airport', 'JAN'],
  ['Jacksonville', 'Jacksonville International Airport', 'JAX'],
  ['Juneau', 'Juneau International Airport', 'JNU'],
  ['Kailua-Kona', 'Kona International Airport', 'KOA'],
  ...
  ['Melbourne (FL)', 'Melbourne Orlando International Airport', 'MLB'],
  ['Memphis', 'Memphis International Airport', 'MEM'],
  ['Miami', 'Miami International Airport', 'MIA'],
  ['Midland', 'Midland International Air and Space Port', 'MAF'],
  ...
  ['New York City (Queens)', 'John F. Kennedy International Airport', 'JFK'],
  ['New York City (Queens)', 'LaGuardia Airport', 'LGA'],
  ...
  ['Richmond (VA) (Sandston)', 'Richmond International Airport', 'RIC'],
  ['Rochester (MN)', 'Rochester International Airport', 'RST'],
  ['Rochester (NY)', 'Greater Rochester International Airport', 'ROC'],
  ['Rockford (IL)', 'Chicago Rockford International Airport', 'RFD'],
  ...
  ['Sanford (FL)', 'Orlando Sanford International Airport', 'SFB'],
  ...
  ['Karakol', 'Karakol International Airport', '', 'UCFP'],
  ...
  ['Baotou', 'Baotou Donghe Airport', 'BAV'],
  ...
  ['Chengdu', 'Chengdu Tianfu International Airport', 'TFU'],
  ...
  ['Chek Lap Kok, New Territories', 'Hong Kong International Airport', 'HKG'],
  ['Taipa, Macau', 'Macau International Airport', 'MFM'],
  ...
  ['Amritsar', 'Sri Guru Ram Dass Jee International Airport', 'ATQ', 'Punjab'],
  [
    'Ayodhya',
  ...
  ['Noida (Delhi NCR)', 'Noida International Airport', 'JWR', 'Uttar Pradesh'],
  ...
  ['Lucknow', 'Chaudhary Charan Singh Airport', 'LKO', 'Uttar Pradesh'],
  ...
  ['Nashik', 'Ozar Airport', 'ISK', 'Maharashtra'],
  ...
  ['Jayapura', 'Dortheys Hiyo Eluay International Airport', 'DJJ'],
  ...
  ['Hồ Chí Minh City', 'Tan Son Nhat International Airport', 'SGN'],
  ...
  ['Jizan', 'Jizan Regional Airport', 'GIZ'],
  ...
  ['Mulhouse', 'EuroAirport Basel Mulhouse Freiburg', 'BSL'],
  ...
  ['Gibraltar', 'Gibraltar International Airport', 'GIB'],
  ['Alderney', 'Alderney Airport', 'ACI'],
  ['Saint Peter Port', 'Guernsey Airport', 'GCI'],
  ...
  ['Saint Helier', 'Jersey Airport', 'JER'],
  ...
  ['Warsaw', 'Warsaw Modlin Airport', 'WMI'],
  ['Warsaw', 'Warsaw Radom Airport', 'RDO'],
  ...
  ['Batumi', 'Batumi International Airport', 'BUS', 'UGSB'],
  ['Kutaisi', 'Kutaisi International Airport', 'KUT', 'UGKO'],
  ['Sokhumi', 'Sukhumi Babushara Airport', 'SUI', 'UGSS'],
  ['Tbilisi', 'Tbilisi International Airport', 'TBS', 'UGTB'],
  ['Pristina', 'Pristina International Airport', 'PRN'],
  ['Chişinău', 'Chișinău International Airport', 'KIV'],
  ...
  ['Dnipro', 'Dnipro International Airport', 'DNK'],
  ...
  ['Kyiv', 'Kyiv International Airport', 'IEV'],
  ...
  ['Reykjavík', 'Reykjavík Airport', 'RKV'],
  ...
  ['Adelaide', 'Adelaide Airport', 'ADL', ' South Australia'],
  ['Brisbane', 'Brisbane Airport', 'BNE', ' Queensland'],
  ['Broome', 'Broome International Airport', 'BME', ' Western Australia'],
  ['Cairns', 'Cairns Airport', 'CNS', ' Queensland'],
  ['Canberra', 'Canberra Airport', 'CBR', ' Australian Capital Territory'],
  ['Darwin', 'Darwin International Airport', 'DRW', ' Northern Territory'],
  ['Gold Coast', 'Gold Coast Airport', 'OOL', ' Queensland'],
  ['Hobart', 'Hobart Airport', 'HBA', ' Tasmania'],
  ['Horn Island', 'Horn Island Airport', 'HID', ' Queensland'],
  ['Melbourne', 'Melbourne Airport', 'MEL', ' Victoria'],
  ['Newcastle', 'Newcastle Airport[2]', 'NTL', ' New South Wales'],
  ['Perth', 'Perth Airport', 'PER', ' Western Australia'],
  [
    'Port Hedland',
  ...
  ['Sunshine Coast', 'Sunshine Coast Airport[3]', 'MCY', ' Queensland'],
  ['Sydney', 'Sydney Airport', 'SYD', ' New South Wales'],
  ['Sydney', 'Western Sydney Airport (upcoming)', 'WSI', ' New South Wales'],
  ...
  ['Dunedin', 'Dunedin Airport', 'DUD', 'Future International Airport'],
  ['Hamilton', 'Hamilton Airport', 'HLZ', 'Future International Airport'],
...
export class AirportListService {
  getAirport(str: string) {
    ...
    //   .slice()
    //   .filter((e) => {
    //     return e.join('___').toLowerCase().includes(str.toLowerCase());
    //   })
    //   .slice(0, 5)
    //   .map((e) => {
    //     return {
    //       display_name: `${e[1]} (${e[2]})`,
    //       city: e[0],
    //       airport_name: e[1],
    //       airport_code: e[2],
    //     };
